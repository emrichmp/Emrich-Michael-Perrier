...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["hero", "demo-reel", "about", "projects", "experience", "coaching", "contact"];

      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-body text-gray-400 max-w-4xl mx-auto">
            ...
            I specialize in full-stack development, focusing on scalable web applications and user-centric design.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="space-y-6 text-body text-gray-300">
              <p>
                ...
                What began as simple HTML pages has evolved into building complex, scalable applications that 
                serve thousands of users.
              </p>
              <p>
                With over [X] years of experience, I've worked on projects ranging from startup MVPs to 
                enterprise-level applications. I believe in writing clean, maintainable code and staying 
                up-to-date with the latest technologies and best practices.
              </p>
              <p>
                When I'm not coding, you'll find me contributing to open-source projects, writing technical 
                blog posts, or exploring new technologies. I'm always eager to learn and share knowledge 
